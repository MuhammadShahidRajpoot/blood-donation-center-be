...
export class AttachmentSubCategoryModule implements NestModule {
  configure(consumer: MiddlewareConsumer) {
    consumer.apply(AuthMiddleware).forRoutes(
      { path: '/contacts/attachment-subcategory', method: RequestMethod.GET },
      {
        path: '/contacts/attachment-subcategory',
        method: RequestMethod.POST,
      },
      {
        path: '/contacts/attachment-subcategory/:id',
