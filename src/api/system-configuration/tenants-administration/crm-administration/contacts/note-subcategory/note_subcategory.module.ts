...
export class ContactsNoteSubCategoryModule {
  configure(consumer: MiddlewareConsumer) {
    consumer
      .apply(AuthMiddleware)
      .forRoutes(
        { path: '/contacts/note-subcategory', method: RequestMethod.POST },
        { path: '/contacts/note-subcategory', method: RequestMethod.GET },
        { path: '/contacts/note-subcategory/:id', method: RequestMethod.GET },
        { path: '/contacts/note-subcategory/:id', method: RequestMethod.PUT },
        { path: '/contacts/note-subcategory/:id', method: RequestMethod.PATCH }
      );
  }
}
