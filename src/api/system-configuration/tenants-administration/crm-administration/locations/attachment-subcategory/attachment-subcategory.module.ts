...
export class LocationsAttachmentSubCategoryModule implements NestModule {
  configure(consumer: MiddlewareConsumer) {
    consumer.apply(AuthMiddleware).forRoutes(
      { path: '/locations/attachment-subcategory', method: RequestMethod.GET },
      {
        path: '/locations/attachment-subcategory/:id',
        method: RequestMethod.GET,
      },
      {
        path: '/locations/attachment-subcategory',
