...
export class AccountsAttachmentCategoryModule implements NestModule {
  configure(consumer: MiddlewareConsumer) {
    consumer.apply(AuthMiddleware).forRoutes(
      { path: '/accounts/attachment-category', method: RequestMethod.GET },
      { path: '/accounts/attachment-category', method: RequestMethod.POST },
      {
        path: '/accounts/attachment-category/:id',
