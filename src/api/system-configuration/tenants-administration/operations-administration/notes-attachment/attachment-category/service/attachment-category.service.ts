...
export class AttachmentCategoryService {
    ...
    try {
      ...
      if (sortName) {
        queryBuilder.orderBy(
          sortName === 'is_active'
            ? sortName
            : `LOWER(attachment_category.${sortName})`,
          sortBy
        );
      } else {
    ...
    try {
      ...
      if (attachment_category) {
        ...
        attachment_category.created_by =
          modified_by && Object.values(modified_by).length
            ? modified_by
            : attachment_category.created_by;
      }
      return resSuccess(
  ...
  async updateAttachmentCategory(id: any, updatedData: any) {
    ...
    try {
      ...
      const updatedAttachmentCategory: any = {
      ...
      updatedAttachmentCategory?.created_by
        ? delete updatedAttachmentCategory?.created_by
        : '';
      ...
      return resSuccess(
        ...
        {
          ...updatedAttachmentCategory,
          tenant_id: attachment_category.tenant_id,
        }
      );
    } catch (error) {
  ...
  async deleteAttachmentCategory(id: any, user: any) {
    ...
    try {
      ...
      delete attachment_category?.created_by;
      return resSuccess(
