...
export class AlterColumnBECSCodeRemoveBigintCRMLocations1711712411310
  implements MigrationInterface
{
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'ALTER TABLE "crm_locations" DROP COLUMN "becs_code"'
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      'ALTER TABLE "crm_locations" ADD COLUMN "becs_code" BIGINT'
    );
    await queryRunner.query(`
