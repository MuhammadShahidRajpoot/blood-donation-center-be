...
export class AlterTableCallJobAgentsReplaceStaffWithUser1712849070830
  implements MigrationInterface
{
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.dropColumn('call_jobs_agents', 'staff_id');
    ...
    LEFT JOIN 
        "staff_roles_mapping" "other_roles" ON "other_roles"."staff_id" = "staff"."id" AND ("other_roles"."is_primary" = TRUE)  AND             ("other_roles"."is_archived" = FALSE)
    LEFT JOIN 
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.dropForeignKey('call_jobs_agents', 'FK_user_id');

    await queryRunner.dropColumn('call_jobs_agents', 'user_id');
